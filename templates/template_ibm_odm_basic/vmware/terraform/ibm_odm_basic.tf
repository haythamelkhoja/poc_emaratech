...
#Variable : ODMNode01_was_liberty_base_version
variable "ODMNode01_was_liberty_base_version" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_edition
variable "ODMNode01_was_liberty_edition" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_install_dir
variable "ODMNode01_was_liberty_install_dir" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_install_grp
variable "ODMNode01_was_liberty_install_grp" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_install_user
variable "ODMNode01_was_liberty_install_user" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_runas_user
variable "ODMNode01_was_liberty_runas_user" {
  type        = "string"
...
#Variable : ODMNode01_was_liberty_wlp_user_dir
variable "ODMNode01_was_liberty_wlp_user_dir" {
  type        = "string"
...
#########################################################
##### Resource : ODMNode01_liberty_install
#########################################################

resource "camc_softwaredeploy" "ODMNode01_odm_basic_install" {
  ...
  data = <<EOT
{
  ...
  "host_ip": "${vsphere_virtual_machine.ODMNode01.clone.0.customize.0.network_interface.0.ipv4_address}",
  "node_name": "${var.ODMNode01-name}",
  "runlist": "role[odm_install_basic]",
  "node_attributes": {
    "ibm": {
    ...
    "was_liberty": {
      "base_version": "${var.ODMNode01_was_liberty_base_version}",
      "edition": "${var.ODMNode01_was_liberty_edition}",
      "install_dir": "${var.ODMNode01_was_liberty_install_dir}",
      "install_grp": "${var.ODMNode01_was_liberty_install_grp}",
      "install_user": "${var.ODMNode01_was_liberty_install_user}",
      "java_version": "8.0",
      "runas_user": "${var.ODMNode01_was_liberty_runas_user}",
      "wlp_user_dir": "${var.ODMNode01_was_liberty_wlp_user_dir}"
    },
    "odm": {
